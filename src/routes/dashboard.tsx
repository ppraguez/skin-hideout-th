...
export const Route = createFileRoute("/dashboard")({
  head: () => ({
    meta: [
      { title: "Dashboard — CS2Hideout" },
      { name: "description", content: "Your CS2Hideout dashboard — hot deals, community and live matches." },
      { property: "og:title", content: "Dashboard — CS2Hideout" },
