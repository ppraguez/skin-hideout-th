...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "CS2Hideout" },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@400;500;600;700&family=Inter:wght@400;500;600;700;800;900&family=JetBrains+Mono:wght@400;500;600&display=swap" },
    ],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "WebSite",
          name: "CS2Hideout",
          description: "Hideout marketplace for CS2 traders — Southeast Asia & worldwide. Zero fees.",
          url: "/",
        }),
      },
    ],
